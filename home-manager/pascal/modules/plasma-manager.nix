...

{
  programs.plasma = {
    ...
    workspace = {
      ...
      wallpaper = "${config.home.homeDirectory}/.local/share/wallpapers/playnix/nixos-gruvbox-minimalism_3440x1440.jpg"; # The Plasma wallpaper. Can be either be the path to an image file or a kpackage.
    };
      ...
      # Windows-like panel at the bottom
      {
        ...
        widgets = [
          ...
          # ~/.config/plasma-org.kde.plasma.desktop-appletsrc.
          {
            ...
            config = {
              General.icon = "${config.home.homeDirectory}/.local/share/icons/playnix/nix-snowflake-rainbow.svg";
            };
          }
