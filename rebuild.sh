...
# To run:
#     bash -c "$(curl https://raw.githubusercontent.com/Mag1cByt3s/PlayNix/main/rebuild.sh)"
...
while true; do
    read -rp "Which host to rebuild? (battlestation) " HOST
    case $HOST in
        battlestation ) break;;
...
log "INFO" "Rebuilding PlayNix with profile ${HOST}"
